    ...
    Markdown.prototype = {
        ...
        , setFullscreen: function (mode) {
            ...
            if (mode) {
                ...
                this.showButtons('cmdIPre');
                //this.showPreview();
                var _left2 = document.querySelector(".md-editor .md-input");
                var _right = $('div[data-provider="markdown-preview"]');
                //默认的分栏模式
                _left2.style.width = '50%';
                _right.css({
                    'display': '',
                    'width': '50%',
                    'left': '50%'
                ...
                var _left = document.querySelector(".md-editor .md-input");
                _left.style.width = '100%';
                this.hideButtons('cmdIPre');
            }
        ...
        , showPreview: function () {
            ...
            this.$isPreview = true;
            // Disable all buttons
            if (document.querySelector("textarea#mdEditor").style.display == 'none') {
        ...
        , localCache: function localCache() {
            var _localStorage = this.$localStorage,
                textarea = this.$textarea;
            if (cachInterval){
                clearInterval(cachInterval);
            }
            if (window.localStorage && _localStorage && '' !== _localStorage) {
                cachInterval = setInterval(function () {
                ...
                data: [{
                ...
                },
                    {
                        ...
                        callback: function (e) {
                            ...
                            if (e.$isFullscreen) {
                                var _right = $('div[data-provider="markdown-preview"]');
                                var _left = $(".md-editor.md-fullscreen-mode .md-input");
                                if (e.fullmode % 3 == 0) {
                                    //默认的分栏模式
                                    _left.css({
                                        'width': '50%'
                                ...
                                if (document.querySelector("textarea#mdEditor").style.display == 'none') {
                                    ...
                                    e.enableButtons('all').enableButtons('cmdIPre');
                                }
                            }
                            if (e.$options.onAfterBtnClick(e, 'cmdIPre')) {
